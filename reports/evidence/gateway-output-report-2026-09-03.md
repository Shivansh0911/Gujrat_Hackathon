...
Merged from **17 ingest pass(es)** against `cctv.corp8.cloud`, 2026-09-01T23:54:25Z to 2026-09-03T05:07:06Z.
...
|---|---:|
| Frames decoded | 3938 |
| Frames passing the motion gate | 326 |
| Plate regions detected | 18 |
| Fused plate records | 1 |
| Grammar-valid registrations | **1** |
| Distinct valid registrations | **1** |

### Registrations read

| Plate | Camera | Confidence | Frames fused | Observed (UTC) |
|---|---|---:|---:|---|
| `GJ09BM3641` | cam22 | 0.76 | 4 | 2026-09-03T05:06:40 |

### The finding that matters

3938 frames across 25 live cameras yielded 18 plate regions and **1 grammar-valid registration**. That is not a pipeline fault: the recogniser reads what is legible, and at the resolution and framing these cameras publish, very little is. The evidence crops are committed, and the unreadable ones are unreadable to a human reviewer too.
...
The organiser's §2.2 warns not to trust the reported frame rate. Of 0 cameras that both declare a rate and delivered frames, **0 diverge by more than 5%**. A further 25 delivered frames while declaring no rate at all.
...
- Merged from 17 pass(es); 30 camera(s) were re-run and the later result supersedes the earlier. Every attempt is retained in the source JSON.
...
Source records: `gateway-ingest-2026-09-01T23-54-25Z.json`, `gateway-ingest-2026-09-02T00-07-48Z.json`, `gateway-ingest-2026-09-02T00-55-29Z.json`, `gateway-ingest-2026-09-02T01-00-11Z.json`, `gateway-ingest-2026-09-02T13-33-51Z.json`, `gateway-ingest-2026-09-02T13-37-31Z.json`, `gateway-ingest-2026-09-02T13-41-18Z.json`, `gateway-ingest-2026-09-02T13-45-31Z.json`, `gateway-ingest-2026-09-02T13-50-03Z.json`, `gateway-ingest-2026-09-02T14-15-36Z.json`, `gateway-ingest-2026-09-02T15-57-06Z.json`, `gateway-ingest-2026-09-02T16-00-25Z.json`, `gateway-ingest-2026-09-02T16-03-32Z.json`, `gateway-ingest-2026-09-02T16-06-38Z.json`, `gateway-ingest-2026-09-02T16-09-47Z.json`, `gateway-ingest-2026-09-02T16-17-44Z.json`, `gateway-ingest-2026-09-03T05-04-59Z.json`
