...
Merged from **16 ingest pass(es)** against `cctv.corp8.cloud`, 2026-09-01T23:54:25Z to 2026-09-02T16:19:32Z.
...
The organiser's §2.2 warns not to trust the reported frame rate. Of 0 cameras that both declare a rate and delivered frames, **0 diverge by more than 5%**. A further 26 delivered frames while declaring no rate at all.
...
- Merged from 16 pass(es); 30 camera(s) were re-run and the later result supersedes the earlier. Every attempt is retained in the source JSON.
