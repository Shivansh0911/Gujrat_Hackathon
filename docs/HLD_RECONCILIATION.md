...
| Feed-contract compliance | **8/8 on 2026-09-02, 0 failed, 0 not exercised** — every check exercised live, and every live check over **RTSP/TCP**, which had never been possible before: 8554 was unreachable until the estate moved hosts. Two harness defects were fixed to get an honest number, one of them a `Check.status` default that rendered a failing check as PASS. Earlier: 8/8 over HLS on 27 Aug; 1 pass and 7 not exercised on 31 Aug against the old gateway's 502 | `preflight-2026-09-01T23-35-14Z` |
